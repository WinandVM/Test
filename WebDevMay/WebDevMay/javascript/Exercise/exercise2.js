...
//         street: "Hovelaan", suite: "85", city: "Bierbeek", zipcode: "3030"}, skills: ['html', ' css', ' photoshop', ' illustrator', ' indesign']
        
    
// }];
// // identifier.forEach(function (user) {
// //     // user.address.city.toUppercase();
// //     console.log(`name: ${user.name}\nusername: ${user.username}\nemail: ${user.email}\nstreet: ${user.address.street}\nsuite: ${user.address.suite}\ncity: ${user.address.city.toUpperCase()}\nzipcode: ${user.address.zipcode}`)
// // });

// identifier.forEach((user) => { //zelfde, maar dan geschreven als arrow function
