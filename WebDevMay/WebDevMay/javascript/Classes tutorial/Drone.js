...
class CivilDrone extends Drone {
    constructor(type="civil drone", speed=50,battery=100){ //dit zijn default values voor als de user niks invult
...
let civil = new CivilDrone(); //we specificeren niets, want we hebben default values
civil.registerDroneOwner('drone#001', 'Winand','Leuven');
